...
<body id="page-top">
          ...
          <div class="card-body">
            <form method="post">
              ...
              <div class="mb-3">
                ...
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Email" name="email" required>
              </div>
              <div class="mb-3">
  ...
  if (isset($_POST['simpan'])) {
    $query = mysqli_query($koneksi, "INSERT INTO `user` (id_user,nama,email,password) VALUES (null,'$_POST[nama]','$_POST[email]','$_POST[password]')"); {
  ?>

      <script type="text/javascript">
        alert("Data anggota Berhasil Disimpan");
        window.location.href = "daftar-user.php";
      </script>
  <?php
    }
  }
