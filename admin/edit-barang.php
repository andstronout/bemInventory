...
$sql = mysqli_query($koneksi, "select * from stok_barang where id_produk ='$id'");
              ...
              <div class="card shadow mb-4">
                <div class="card-body">
                  <form method="POST">
                    ...
                    <div class="mb-3">
                      <label for="exampleInputjumlah1" class="form-label">Jumlah Barang</label>
                      <input type="jumlah" class="form-control" id="exampleInputjumlah1" aria-describedby="jumlahHelp" name="jumlah_barang" required value="<?= $tampil['jumlah_barang']; ?>">
                    </div>
